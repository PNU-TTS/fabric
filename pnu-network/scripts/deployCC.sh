...
packageChaincode ManagementPeerOrg

## Install chaincode on peer0.management-peer-org and peer0.rec-client-peer-org
echo "Installing chaincode on peer0.management-peer-org..."
installChaincode ManagementPeerOrg
echo "Install chaincode on peer0.rec-client-peer-org..."
installChaincode RecClientPeerOrg

## query whether the chaincode is installed
queryInstalled ManagementPeerOrg

## approve the definition for management-peer-org
approveForMyOrg ManagementPeerOrg

## check whether the chaincode definition is ready to be committed
## expect management-peer-org to have approved and rec-client-peer-org not to
checkCommitReadiness ManagementPeerOrg "\"ManagementPeerOrgMSP\": true" "\"RecClientPeerOrgMSP\": false"
checkCommitReadiness RecClientPeerOrg "\"ManagementPeerOrgMSP\": true" "\"RecClientPeerOrgMSP\": false"

## now approve also for rec-client-peer-org
approveForMyOrg RecClientPeerOrg

## check whether the chaincode definition is ready to be committed
## expect them both to have approved
checkCommitReadiness ManagementPeerOrg "\"ManagementPeerOrgMSP\": true" "\"RecClientPeerOrgMSP\": true"
checkCommitReadiness RecClientPeerOrg "\"ManagementPeerOrgMSP\": true" "\"RecClientPeerOrgMSP\": true"

## now that we know for sure both orgs have approved, commit the definition
commitChaincodeDefinition ManagementPeerOrg RecClientPeerOrg

## query on both orgs to see that the definition committed successfully
queryCommitted ManagementPeerOrg
queryCommitted RecClientPeerOrg

## Invoke the chaincode
chaincodeInvokeInit ManagementPeerOrg RecClientPeerOrg

sleep 10

# Query chaincode on peer0.management-peer-org
echo "Querying chaincode on peer0.management-peer-org..."
chaincodeQuery ManagementPeerOrg
