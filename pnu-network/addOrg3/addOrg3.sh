...
function printHelp () {
  ...
  echo "    -c <channel name> - test network channel name (defaults to \"rec-trade-channel\")"
  ...
  echo "	addOrg3.sh up"
  echo "	addOrg3.sh up -c rec-trade-channel -s couchdb"
...
# be put in the organizations folder with management-peer-org and rec-client-peer-org
